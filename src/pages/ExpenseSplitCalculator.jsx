...
const styles = {
  ...
  label: {
    fontFamily: "Manrope, sans-serif", fontSize: "0.88rem", fontWeight: 600,
  ...
  gtAmount: { fontSize: "1.1rem", fontWeight: 700, color: "var(--ac-dk)", fontFamily: "Manrope, sans-serif" },
  ...
  personOwes: { fontSize: "1rem", fontWeight: 700, color: "var(--ac-dk)", fontFamily: "Manrope, sans-serif", marginBottom: 2 },
  ...
  settleAmount: {
    ...
    color: "var(--ac-dk)", fontFamily: "Manrope, sans-serif",
